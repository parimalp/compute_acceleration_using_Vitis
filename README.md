...
- [Vitis Introduction: Acceleration Workflow](#vitis-introduction-acceleration-workflow)
  ...
  - [Section 4: Use Vitis Vision Library to Accelerate More Functions](#section-4-use-vitis-vision-library-to-accelerate-more-functions)
    - [Section 4a: Build and Run Project in CLI Mode (15 minutes)](#section-4a-build-and-run-project-in-cli-mode)
  ...
  - [Section 5: Memory Allocation Tips](#section-5-memory-allocation-tips)
    ...
    - [Section 5b: Build Project (15 minutes)](#section-5b-build-project)
  ...
  - [Section 6: Do Computing and Transferring in Parallel](#section-6-do-computing-and-transferring-in-parallel)
    - [Section 6a: Build Project (15 minutes)](#section-6a-build-project)
  ...
  - [Section 7: Kernel Streaming Interface](#section-7-kernel-streaming-interface)
    - [Section 7a: Build and Run the Project (10 minutes)](#section-7a-build-and-run-the-project)
...
[UG1301: Getting Started with Alveo Data Center Accelerator Cards](https://www.xilinx.com/support/documentation/boards_and_kits/accelerator-cards/1_4/ug1301-getting-started-guide-alveo-accelerator-cards.pdf)

[UG1233: Xilinx OpenCV User Guide](https://www.xilinx.com/support/documentation/sw_manuals/xilinx2019_1/ug1233-xilinx-opencv-user-guide.pdf)

[UG1352: Vitis Acceleration Development](https://www.xilinx.com/support/documentation-navigation/design-hubs/dh0088-vitis-acceleration.html)
 
## Next Steps

Hope you have feel the fun of Vitis hardware acceleration in this tutorial. Developers for sure would like to see how their application would finally run on real hardware. We would hope to support you to accomplish it.

The process to convert a software emulation application to the one for real hardware deployment is straightforward. You don't need to change the software. There is no need to set `XCL_EMULATION_MODE` environment variable.
...
Alveo cards can be purchased from https://www.xilinx.com/alveo.

[Alveo cards, Available acceleration applications, Application developer tool](https://www.xilinx.com/products/boards-and-kits/alveo.html)

[Alveo U200 and U250 Data Center Accelerator Cards User Guide](https://www.xilinx.com/support/documentation/boards_and_kits/accelerator-cards/ug1289-u200-u250-reconfig-accel.pdf) 

[Alveo Accelerator Card Product Selection Guide](https://www.xilinx.com/support/documentation/selection-guides/alveo-product-selection-guide.pdf)
